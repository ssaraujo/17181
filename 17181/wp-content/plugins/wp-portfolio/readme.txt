...
If you get the 'other_error - Data from STW was empty.' error, that's probably because your STW account has been disabled for some reason. Log into your STW account and check what it says.

...
function cleanpress_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'cleanpress_custom_header_args', array(
		...
		'admin-head-callback'    => 'cleanpress_admin_header_style',
		'admin-preview-callback' => 'cleanpress_admin_header_image',
	) ) );
}
...
if ( ! function_exists( 'cleanpress_admin_header_style' ) ) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see cleanpress_custom_header_setup().
 */
function cleanpress_admin_header_style() {
?>
	<style type="text/css">
...
endif; // cleanpress_admin_header_style

if ( ! function_exists( 'cleanpress_admin_header_image' ) ) :
/**
 * Custom header image markup displayed on the Appearance > Header admin panel.
 *
 * @see cleanpress_custom_header_setup().
 */
function cleanpress_admin_header_image() {
...
endif; // cleanpress_admin_header_image
